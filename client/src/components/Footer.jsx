    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-primary/10">
            ...
            <p className="py-4 text-center text-sm md:text-base text-gray-600/80">
                    Project By - <b className="text-green-800 text-lg"><a href="https://www.linkedin.com/in/kartiktya">Kartik Tyagi</a>, <a href="">Dhruv Sharma</a>, <a href="">Himanshu Singh</a></b>
            </p>


            <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
                Copyright {new Date().getFullYear()} © LoopKart (All Rights Reserved).
            </p>
